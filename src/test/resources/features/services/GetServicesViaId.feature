...
Feature: Get services via id
  ...
  Scenario: Try to get all services with invalid service id
    Given I am a valid user
  ...
  @GetProducts @NegativeScenario
  Scenario: Try to get all services with non-existing service id
    Given I am a valid user
