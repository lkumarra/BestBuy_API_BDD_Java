...
@CucumberOptions(features = { "classpath:features/categories", "classpath:features/products",
		"classpath:features/services" }, glue = { "demo.bestbuy.com.categories", "demo.bestbuy.com.commonsteps",
				"demo.bestbuy.com.hooks", "demo.bestbuy.com.products", "demo.bestbuy.com.services" }, plugin = {
