...
public final class VerifyResponseSteps {
    ...
    public void product_should_be_returned_with_status_code_name_as_and_message_as(String statusCodeEnumString, String name, String message) throws Exception {
        ResponseModalWrapper responseModalWrapper = new ResponseModalWrapper();
        StatusCodeEnum statusCodeEnum = Enum.valueOf(StatusCodeEnum.class, statusCodeEnumString);
        int statusCode = StatusCodeWrapper.getStatusCodeViaEnum(statusCodeEnum);
        responseModalWrapper.setCode(statusCode);
    ...
    public void response_should_not_be_returned_with_name_as_message_as_status_code_and_errors_as(String name, String message, String statusCodeEnumString, String errors) throws Exception {
        ResponseModalWrapper responseModalWrapper = new ResponseModalWrapper();
        StatusCodeEnum statusCodeEnum = Enum.valueOf(StatusCodeEnum.class, statusCodeEnumString);
        int statusCode = StatusCodeWrapper.getStatusCodeViaEnum(statusCodeEnum);
        responseModalWrapper.setCode(statusCode);
