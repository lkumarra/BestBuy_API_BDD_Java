...
public final class CategoriesDBHelper {
    ...
    public static List<GetCategoryDatum> getCategoriesList() {
        ...
        return dataTable.stream().map(row -> {
            ...
            category.setCreatedAt(formatDateString(row.get(CategoriesTableKeys.CREATEDAT)));
            category.setUpdatedAt(formatDateString(row.get(CategoriesTableKeys.UPDATEDAT)));
    ...
    private static List<GetCategorySubCategory> getSubcategoriesList(String categoryId) {
        ...
        return dataTable.stream().map(row -> {
            ...
            try {
                ...
                subCategory.setCreatedAt(formatDateString(row.get(CategoriesTableKeys.CREATEDAT)));
                subCategory.setUpdatedAt(formatDateString(row.get(CategoriesTableKeys.UPDATEDAT)));
            } catch (Exception e) {
    ...
    private static List<GetCategoryCategoryPath> getCategoryPathList(String categoryId) {
        ...
        return dataTable.stream().map(row -> {
            ...
            try {
                ...
                categoryPath.setCreatedAt(formatDateString(row.get(CategoriesTableKeys.CREATEDAT)));
                categoryPath.setUpdatedAt(formatDateString(row.get(CategoriesTableKeys.UPDATEDAT)));
            } catch (Exception e) {
                // Handle potential errors such as null values or parsing issues
