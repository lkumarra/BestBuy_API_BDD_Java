package demo.bestbuy.com.helpers.restassuredhelper;
...
public final class RestAssuredHelper {
    ...
    public <T> T getMappedResponse(String response, Class<T> clazz) {
        try {
            ...
            log.error("Error while mapping the response in class with error message : {}", e.getMessage());
        } catch (JsonProcessingException e) {
            log.error("Error while processing the JSON with error message : {}", e.getMessage());
        }
        return null;
    }
    ...
    public String serializedObject(Object object) {
        ...
        try {
            ...
            log.error("Error while serializing the object with error message : {}", e.getMessage());
        }
