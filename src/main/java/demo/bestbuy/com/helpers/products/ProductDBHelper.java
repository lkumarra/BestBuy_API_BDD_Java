...
public final class ProductDBHelper {
    ...
    public static List<GetProductDatum> getProductsList() {
        ...
        return dataTable.stream().map(row -> {
            ...
            try {
                ...
                product.setCreatedAt(formatDateString(row.get(ProductTableKeys.CREATEDAT)));
                product.setUpdatedAt(formatDateString(row.get(ProductTableKeys.UPDATEDAT)));
    ...
    public static List<GetProductCategory> getFilteredCategories(int productId) {
        ...
        return dataTable.stream().map(row -> {
            ...
            productCategory.setCreatedAt(formatDateString(row.get(ProductTableKeys.CREATEDAT)));
            productCategory.setUpdatedAt(formatDateString(row.get(ProductTableKeys.UPDATEDAT)));
