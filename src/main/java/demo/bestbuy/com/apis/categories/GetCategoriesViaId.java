package demo.bestbuy.com.apis.categories;
...
import demo.bestbuy.com.helpers.apidatabasehelper.categories.CategoriesDBHelper;
...
public final class GetCategoriesViaId extends BaseAPI {
    ...
    public void executeGetCategoriesViaIdAPI(String categoryId) {
    ...
    public void verifyGetCategoriesViaIdFromDB() {
